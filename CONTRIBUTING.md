...
1. Fork the `https://github.com/girardinsamuel/masonite-billing` repo.
2. Clone that repo into your computer: `git clone http://github.com/your-username/masonite-billing.git`.
...
- When making changes to your packages you will need to uninstall the package and reinstall it with
  `pip uninstall masonite-billing && pip install .`
